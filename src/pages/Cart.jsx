    ...
    <div className="container mx-auto ">
      {cart.length === 0 ? (
        ...
        Your Cart:
              ...
              >
                ...
                <div className="flex-1 ml-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {/* Only show the minus button if quantity is greater than 1 */}
                    {item.quantity > 1 && (
                      <button
          ...
          {/* Checkout Button */}
          <button className="flex items-center gap-4 mx-auto bg-lime-200 rounded-xl py-3 px-2 w-full md:w-[60%] justify-center mt-4 text-lime-950 hover:text-rose-900 hover:bg-red-300 transition font-heading tracking-widest text-lg cursor-pointer">
            Proceed to Checkout
            <FaMoneyBillWave />
          </button>
        </div>
